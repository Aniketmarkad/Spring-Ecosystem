...
public class TestBDataFetchRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		System.out.println("output := ----case-4 -- n column --Mixed order-");
